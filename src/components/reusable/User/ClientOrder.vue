   ...
   <div>
      <div>
         <div class="row mt-lg-0 mt-5">
            ...
            <div class="col-lg-4 col-md-12 col-12 mt-2 mytabs-div client-top" id="clientOrderTop">
               <div class="">
                  <p class="text-center watermark-header text-uppercase">Client order permissions</p>
               </div>
               <form @submit.prevent="send()" class="text-start">
                  <input class="select-all" type="checkbox" v-model="checkAll" id="selectAllCheckbox5">
                  <label  class="text-uppercase selected-all-label select-prod-label" for="selectAllCheckbox5">
...
export default {
 ...
 data() {
      return {
          ...
          { item: '2', name: 'Cards'},
          { item: '3', name: 'Free shipping (studio pays)'},
          { item: '4', name: 'Tax exempt'},
        ],

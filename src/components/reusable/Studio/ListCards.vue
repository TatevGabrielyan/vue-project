    ...
    <div>
        <div class="row">
         <div class="col-lg-3"></div>
             <div class="col-lg-9 col-md-6 col-12 mytabs-div" id="listCards">
                  <div class="text-center pr-5">
                           <p class="watermark-header text-uppercase">Studio cards</p>
                        </div>
    ...
    return {
     ...
     column: [
        ...
        },
        {
         ...
         { key: 'enterDate', label: 'DESCRIPTION', sortable: true }

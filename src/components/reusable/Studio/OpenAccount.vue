    ...
    <div>
        <div class="row">
         <div class="col-lg-3"></div>
             <div class="col-lg-9 col-md-12 col-12 mytabs-div" id="openAcc">
                  <div class="text-center pr-5">
                           <p class="watermark-header text-uppercase">Open Account A / R</p>
                        </div>
       ...
       <div v-if="hasRecords">
         ...
         <Button class="text-uppercase create-btn w-auto px-5 mt-3 save-btn" v-b-modal.modal-credit>Add credit</Button>
                </div>

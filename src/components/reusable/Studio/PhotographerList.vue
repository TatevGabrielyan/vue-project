    ...
    <div>
        <div class="row">
         <div class="col-lg-3"></div>
             <div class="col-lg-9 col-md-6 col-12 mytabs-div"  id="studioAddPhotographer">
                <div class="text-center">
                           <p class="watermark-header text-uppercase">PHOTOGRAPHERS LIST</p>
                        </div>
  ...
  data() {
    return {
     ...
     column: [
        ...
        { key: 'delete', label: 'delete', sortable: true }
      ],
